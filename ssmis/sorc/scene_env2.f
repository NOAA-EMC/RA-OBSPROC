...
!---------------------------------------------------------------------------------------------------------
      ...
      end module scene_env2
!---------------------------------------------------------------------------------------------------------
!---------------------------------------------------------------------------------------------------------
      subroutine read_env2(ncid)
...
! read the groupid and the dimensions freom the group
      ...
      print*,'reading env2',scans,nspot,nchan
...
! apply timeseries adjustments to tb for ssmi like channels
