...
!---------------------------------------------------------------------------------------------------------
      ...
      end module scene_img2
!---------------------------------------------------------------------------------------------------------
!---------------------------------------------------------------------------------------------------------
      subroutine read_img2(ncid)
...
! read the groupid and the dimensions freom the group
      ...
      print*,'reading img2',scans,nspot,nchan
...
! apply time series adjustment to tb for ssmi like channels
